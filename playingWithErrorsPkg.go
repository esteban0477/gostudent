...
func main() {
	...
	something := errors.New("this is an error")

	fmt.Println(something)
	fmt.Printf("%T\n", something)
	fmt.Println(something.Error())

	somethingelse := errors.New("This is another error")

	fmt.Println()
	fmt.Println(somethingelse)
	fmt.Printf("%T\n", somethingelse)
	fmt.Println(somethingelse.Error())

	somethinglocal := errorString{
		s: "This is local",
	}

	fmt.Println()
	fmt.Println(somethinglocal)
	fmt.Printf("%T\n", somethinglocal)
	fmt.Println(somethinglocal.Error())
